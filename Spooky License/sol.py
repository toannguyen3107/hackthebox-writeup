...
# Define the list v4 with 32 integer variables
v4 = [Int(f'v4[{i}]') for i in range(32)]

# Create a solver instance
solver = Solver()

# Add constraints based on the equations provided
...
solver.add(v4[9] == 112)
solver.add(v4[21] + v4[19] == v4[6] + 128)
...
# Check for satisfiability and print the solution if available
if solver.check() == 'sat':
    model = solver.model()
    solution = [model[v4[i]] for i in range(32)]
    print("Solution for v4:", solution)
else:
